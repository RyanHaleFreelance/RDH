	...
	return (
		<section id="cards" className='section'>
			<div className='container full container--no-flex'>
				<div>
					<h2 className="textBlockTitle">Our key values</h2>
				</div>
				<div className="textBlockInner">
					<p>RDH Digital are specialists when it comes to what we offer as a service. With over 10 years experience in the business, we have developed these 4 key values that we ensure to uphold on every job. We are sure we can help you with your digital needs.</p>
				</div>
				<div className={Styles.cards}>
					<a href="#contact" className={c(Styles.card, 'card1')}>
					...
					<a href="#contact" className={c(Styles.card, 'card2')}>
						<div className={Styles.cardText}>
						...
						<div className={Styles.cardImage}><img src="https://dev-rdhbackend.pantheonsite.io/wp-content/uploads/2023/02/smartmockups_ldrfr0fo.png"/></div>
						<div className={c(Styles.innerWrapper, 'cardInnerWrapper')}></div>
					</a>
					<a href="#contact" className={c(Styles.card, 'card3')}>
						<div className={Styles.cardText}>
							<h3>Technology</h3>
						...
						<div className={Styles.cardImage}><img className={Styles.bg} src="https://dev-rdhbackend.pantheonsite.io/wp-content/uploads/2023/02/logos.svg"/></div>
						<div className={c(Styles.innerWrapper, 'cardInnerWrapper')}></div>
					</a>
					<a href="#contact" className={c(Styles.card, 'card4')}>
						<div className={Styles.cardText}>
							<h3>Personal</h3>
